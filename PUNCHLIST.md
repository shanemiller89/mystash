...
- [ ] **16c. Convention: note identification**
...
- [ ] **16e. Rate limiting & error handling**
...
- [ ] **17a. Package.json: register tree view**
...
- [ ] **17c. GistNotesProvider (TreeDataProvider)**
...
- [ ] **17e. Tree view registration & wiring**
...
- [ ] **19b-i. Webview → Extension messages**
...
- [ ] **19b-ii. Extension → Webview messages**
...
- [ ] **19b-iii. StashPanel message handler expansion**
...
- [ ] **19c-iii. NotesTab container component**
...
- [ ] **20b. Syntax highlighting for fenced code blocks**
...
| 16. Gist Service                 | 5         | 0    | 5         |
| 17. Gist Notes Tree View         | 5         | 0    | 5         |
| 18. Webview Tab Bar              | 3         | 0    | 3         |
| 19. Notes Tab — List & Editor    | 9         | 0    | 9         |
| 20. Markdown Rendering           | 3         | 0    | 3         |
| 21. Gist Notes Testing           | 5         | 0    | 5         |
| 22. Release Prep — v0.2.0        | 4         | 0    | 4         |
| **Total**                        | **122**   | **88** | **34**  |
