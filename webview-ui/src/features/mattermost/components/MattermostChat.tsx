...
import { useMattermostStore, type MattermostPostData, type MattermostChannelData } from '../store';
...
import { useMattermostMarkdownPlugins } from '../markdownPlugin';
        ...
        <div className="border-b border-[var(--vscode-panel-border)] px-3 py-2 bg-[var(--vscode-editor-background)]">
            ...
            {info.header && (
                <div className="text-xs text-fg/60 mb-1">
                    ...
                    <MarkdownBody content={info.header} renderPlugins={mmPlugins} />
                </div>
            )}
            {info.purpose && (
            ...
            <div className="flex-1 min-w-0">
                ...
                {isEditing ? (
                    ...
                    <div className="text-sm mt-0.5">
                        <MarkdownBody content={post.message} currentUsername={currentUsername} renderPlugins={mmPlugins} />
                    </div>
                )}
                    ...
                    {showPreview && messageText.trim() && (
                        <div className="mb-2 rounded border border-[var(--vscode-panel-border)] bg-[var(--vscode-editor-background)] p-2 max-h-40 overflow-y-auto">
                            ...
                            <div className="text-sm">
                                <MarkdownBody content={messageText} currentUsername={currentUsername} renderPlugins={mmPlugins} />
                            </div>
                        </div>
                    )}
