...
import { useStashStore } from '@stashes/store';
import { useAppStore } from './appStore';
import { onMessage, postMessage } from './vscode';
import { StashList } from '@stashes/components/StashList';
import { StashDetail } from '@stashes/components/StashDetail';
import { TabBar } from '@/components/shared/TabBar';
import { NotesTab } from '@notes/components/NotesTab';
import { PRsTab } from '@prs/components/PRsTab';
import { IssuesTab } from '@issues/components/IssuesTab';
import { ProjectsTab } from '@projects/components/ProjectsTab';
import { MattermostTab } from '@mattermost/components/MattermostTab';
import { ResizableLayout } from '@/components/shared/ResizableLayout';
import { ErrorBoundary } from '@/components/shared/ErrorBoundary';
import { useAIStore } from '@ai/store';
import { FloatingChat } from '@ai/components/FloatingChat';
import { AgentTab } from '@ai/components/AgentTab';
import { SettingsTab } from '@settings/components/SettingsTab';
import { TabWithSummary } from '@/components/shared/TabWithSummary';
import { DriveTab } from '@drive/components/DriveTab';
import { CalendarTab } from '@calendar/components/CalendarTab';
import { WikiTab } from '@wiki/components/WikiTab';
