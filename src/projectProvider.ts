...
export class ProjectProvider implements vscode.TreeDataProvider<ProjectItemTreeItem>, vscode.Disposable {
    ...
    async getChildren(_element?: ProjectItemTreeItem): Promise<ProjectItemTreeItem[]> {
        ...
        try {
            ...
            if (!isAuth) {
                await vscode.commands.executeCommand('setContext', 'workstash.hasProjects', false);
                this._cachedItems = [];
            ...
            await vscode.commands.executeCommand('setContext', 'workstash.hasProjects', hasItems);
