...
export class AuthService implements vscode.Disposable {
	...
	private static readonly _scopes = ['gist'];
	...
	public readonly onDidChangeAuthentication: vscode.Event<void> = this._onDidChangeAuthentication.event;
	...
	async signOut(): Promise<void> {
		...
		try {
			...
			await vscode.authentication.getSession(
				AuthService._providerId,
				AuthService._scopes,
				{ forceNewSession: { detail: 'Sign out of Workstash Gist Notes' } }
			);
		} catch {
