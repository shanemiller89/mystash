...
export class IssueProvider implements vscode.TreeDataProvider<IssueItem>, vscode.Disposable {
    ...
    async getChildren(_element?: IssueItem): Promise<IssueItem[]> {
        ...
        try {
            ...
            if (!isAuth) {
                await vscode.commands.executeCommand('setContext', 'superprompt-forge.hasIssues', false);
                this._cachedIssues = [];
            ...
            await vscode.commands.executeCommand('setContext', 'superprompt-forge.hasIssues', hasIssues);
