...
suite('GistService Unit Tests', () => {
    ...
    suite('listNotes', () => {
        ...
        test('parses Workstash notes from gist list', async () => {
    ...
    suite('createNote', () => {
        test('sends correct payload', async () => {
            ...
            assert.strictEqual(body.description, '[Workstash] Brand New');
            assert.strictEqual(body.public, false);
            assert.ok(body.files['.workstash-note']);
    ...
    suite('updateNote', () => {
        test('updates content and description', async () => {
            ...
            assert.strictEqual(patchBody.description, '[Workstash] New Title');
    ...
    suite('toData', () => {
        test('converts GistNote to GistNoteData with ISO date strings', () => {
            const note: GistNote = {
                ...
                description: '[Workstash] Data Test',
            };
